...
## Sección 2 — Las 5 creencias que te están frenando
...
5. **"Necesito una idea única."** No. Como trabajaste en F0 con Más/Mejor/Nuevo de Alex Hormozi: la inmensa mayoría del dinero está en hacer lo que otros ya hacen, un poco mejor. Nadie reinventó la rueda para forrarse; la hicieron girar mejor.

"Fíjate en el patrón: las cinco excusas apuntan fuera. El nicho, el dinero, el sector. Ninguna apunta a lo único que controlas: ejecutar."
...
## Sección 5 — Anteojeras: el síndrome del objeto brillante

- Nómbralo sin piedad: el síndrome del objeto brillante — la tendencia a abandonar lo que haces por la siguiente idea emocionante. Lo firmaste en tu manifiesto de F0: esto es ruido, no señal.
- Realidad por adelantado: tu nicho te va a enseñar sus miserias. Todos los nichos tienen pros y contras, y tú vas a conocer los dos. Es normal y no significa nada.
- **Cambiar de nicho sin datos = empezar de cero**: tiras el avatar, la oferta, el idioma aprendido y los casos en marcha.
- La única puerta de salida legítima es la regla de validez de F0: 300 toques o 30 llamadas ANTES de sentenciar que un nicho "no funciona". "Sin esos datos no hay decisión: hay huida."
- Y sí, moverte a una vertical cercana costará poco… con datos en la mano y los 90 días cumplidos — no es una puerta trasera para huir del primer nicho.
