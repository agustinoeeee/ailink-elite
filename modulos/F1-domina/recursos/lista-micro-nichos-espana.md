...
|---|---|---|---|---|
| **Clínicas dentales** | Citas que se caen (no-shows) y teléfono sin atender en horas punta | Recuperación de no-shows y citas + recepcionista IA | Cada sillón vacío es facturación perdida con un ticket alto por paciente | Decisor: dentista propietario. Recepción filtra: entra mejor a primera hora o por email/formulario |
...
| **Talleres mecánicos** | Nadie coge el teléfono con las manos en el motor | Recepcionista IA + presupuestos automáticos | Coche que no entra = reparación que se lleva otro taller | Dueño a pie de taller: visita presencial o WhatsApp funcionan bien |
| **Empresas de reformas e instaladores** | Presupuestos lentos y leads sin seguimiento | Presupuestos automáticos + seguimiento de leads | Un solo presupuesto ganado paga años de tu servicio | Decisor en obra durante el día: teléfono a última hora o WhatsApp |
| **Restaurantes** ⚠️ | Reservas sin gestionar y no-shows | Gestión de reservas + automatización de reseñas Google | ⚠️ Matiz: ticket bajo → solo compensa con volumen (grupos, eventos, alta rotación) | Acceso fácil, pero elige locales con volumen o reservas de grupo, no el bar de menú del día |
| **Alojamientos turísticos** | Preguntas repetitivas de huéspedes 24/7 en varios canales | Chatbot de atención + automatización de reseñas Google | Cada reseña y cada reserva directa (sin comisión de portal) es margen puro | Propietarios multi-alojamiento y casas rurales: digitalizados y accesibles por email |

## Catálogo de soluciones AILINK (referencia rápida)

Recepcionista IA (WhatsApp/llamadas) · Recuperación de no-shows y citas · Cualificación y seguimiento de leads · Presupuestos automáticos · Gestión documental · Automatización de reseñas Google · Chatbot web cualificador · Informes automáticos.

## Cómo usar esta lista

1. Marca 1-3 candidatos por **acceso** (¿conoces a alguien dentro? ¿tienes uno cerca?) y **atracción** (¿te ves 90 días con esta gente?).
