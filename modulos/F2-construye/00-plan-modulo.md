...
4. Tono anti-miedo técnico constante: "no necesitas saber programar; necesitas saber DIRIGIR" — pero sin prometer magia: las cosas fallan, se itera (método de F0-L6).
5. Referencias hacia atrás sin re-explicar: la oferta V1 (F1-L7), el catálogo de soluciones (F1-R1), "una demo que falla delante del cliente = credibilidad muerta" (F0-L5, error 6), Más/Mejor/Nuevo.
