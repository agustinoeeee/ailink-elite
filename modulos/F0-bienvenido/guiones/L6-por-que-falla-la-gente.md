...
- "Cuando alguien falla con este modelo, casi nunca es porque el modelo no funcione. Es por uno de estos 7 errores. Todos son evitables. Y hoy te vacunas contra los siete."
- [PANTALLA: lista de 7 huecos numerados, en blanco, que se irán rellenando durante la lección]

## Sección 1 — Error 1: decidir con emociones en vez de datos

- El patrón: mirar tus métricas 10 veces al día y tocar cosas que aún no tienen muestra. Matas un canal de outreach en 3 días, reescribes tu oferta tras 2 noes.
- Sin muestra suficiente no hay información: hay ansiedad disfrazada de gestión.
- Antídoto: deja respirar cada test. Se mira la métrica cuando toca, no cuando duele.
- "Si guías el negocio con el estómago, el estómago te lo va a cerrar."
...
- De los siete, este mata más agencias que los otros seis juntos.
...
- Una demo que falla delante del cliente = credibilidad muerta. No hay segunda primera impresión.
- Enlaces rotos, páginas lentas, formularios que no envían: cada uno te cuesta reuniones que pagaste con tiempo o dinero.
- Antídoto: aquí se testea TODO antes de exponerlo — la demo entera la noche anterior, cada enlace, cada formulario, en móvil y en ordenador.

## Sección 7 — Error 7: huir de las ventas y del seguimiento

- No hay versión de este negocio sin vender. Ninguna.
- Las dos huidas típicas: esconderse en la parte técnica ("mejoro la demo una semana más") y no hacer seguimiento ("no quiero molestar"). Las dos son la misma cobardía con distinto disfraz.
- Antídoto: contactos consistentes, seguimiento sistemático, sin excusas. En F4 te doy el proceso completo; aquí instalas la actitud: las ventas no se delegan y no se posponen.
