# F0 | Bienvenido — KPIs del módulo

## KPIs del alumno (los que él debe cumplir en la semana 1)
...
## KPIs de Agustín como operador del programa (salud del onboarding)

| KPI | Benchmark objetivo | Por qué importa |
|---|---|---|
| % alumnos con kick-off hecha en <72h | > 80% | El 80% del arrepentimiento de compra ocurre en las primeras 24-48h; la kick-off inmediata lo mata (principio heredado del curso fuente: cero tiempo muerto post-pago) |
| % alumnos que completan F0 en ≤7 días | > 70% | Predictor nº1 de que terminarán el programa |
| % formularios completados antes de la kick-off | > 90% | Sin formulario, la kick-off no puede personalizar la ruta |
| Tiempo medio hasta primera acción (cualquier checkbox) | < 24h | Momentum inicial |
