# Brief de diseño — F0 Bienvenido (AILINK Élite)

Lee este archivo ANTES de diseñar nada. Los `.md` de esta carpeta son el **contenido cerrado**. Tú no reescribes, no resumes, no añades módulos, no inventas un “kit extra”. Solo das forma visual a lo que ya está escrito.

**Programa:** AILINK Élite · onboarding 90 días · español de España · tuteo.  
**Uso:** adjuntos de lección en Skool + imprimible.  
**Qué te están pidiendo:** entregables del ALUMNO, no diapositivas de grabación, no landing, no logo nuevo.

---

## Qué hay en esta carpeta (y qué hacer con cada uno)
...
| `00-BRIEF-DISENO.md` | Este brief | No se diseña | — | — |

---

## Marca (si no te pasan logo, usa esto)

- Fondo papel: `#F5F5F2` · tarjetas `#FFFFFF` · tinta `#101010`
- Acento cobalto: `#2743D0` · OK `#1F7A4D` · aviso `#A35C0A`
- Tipografía: grotesk seria (tipo Inter / Geist / similar). Cero script, cero “startup gradient”, cero 3D, cero stock de gente feliz.
- Tono visual = el del texto: directo, sobrio, caro por quietud. Como un contrato, no como un infoproducto de YouTube.
- Palabra marca: **AILINK Élite** en cada pie de página, pequeña. En el manifiesto, también en cabecera.

---

## Reglas innegociables

1. **El copy se respeta.** No cambies frases, no “mejores” el tono, no acortes el manifiesto ni el árbol. Si no cabe, sube cuerpo a 2 páginas o reduce márgenes/cuerpo de texto — no el contenido.
...
### 5. Plantilla de tests
Página 1: las 5 líneas de uso + las 2 reglas (300 toques / 30 llamadas) en cajas imposibles de saltarse. Página 2: la tabla con las 12 columnas del md, ancha, una fila de ejemplo (clínicas dentales) ya rellena + 3 filas vacías. Si es más útil como Sheet: mismas columnas, fila 1 = encabezados, fila 2 = ejemplo.

### 6. Formulario
Cero PDF. El md ya es el spec de Tally/Typeform (9 preguntas, tipos, notas bajo pregunta, pantalla final). No lo conviertas en “workbook”.
